      ...
      <div style={{ display: 'flex', justifyContent: 'center', padding: '48px 24px 100px' }}>
        ...
        >
          ...
          <div style={{ padding: '44px 44px 56px' }}>
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.8rem', color: colors.primary, display: 'block'}}>
              // project
            </span>
            <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(1.8rem, 3vw, 2.4rem)', marginTop: 0, marginBottom: 32, color: colors.ink }}>
              {project.title}
            </h1>
            {/* <p style={{ fontSize: '1.08rem', color: colors.inkSoft, marginBottom: 32, lineHeight: 1.75 }}>{project.desc}</p> */}
            ...
            {project.images && project.images.length > 0 && <ImageSlider images={project.images} />}
            ...
            {project.code && <CodePanel filename="CodeSample.jsx" code={project.code} />}
